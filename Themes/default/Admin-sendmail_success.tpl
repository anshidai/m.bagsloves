...
<style type="text/css">
.overlay{top:0;left:0;z-index:10000;width:100%;height:100%;background:#000;filter:alpha(opacity=30);opacity:0.3;position:fixed;display:none;}
</style>
</head>
<body style="height: auto; overflow: auto;">
<include file="Themes/default/Public/header.tpl" />            

<div id="body_box" class="common_top common_account_box account_trackno user_email">
    <div class="email_tips">
    <div class="success_icon"><i></i>{$msg}</div>
</div>
