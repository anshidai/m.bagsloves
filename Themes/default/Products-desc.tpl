...
<div id="body_box" class="product_specificat">
	<div class="product_detail_content wrap">
		<h3 class="commonh3_1 tit">Product Description</h3>
		<div class="product_desc">{$info.remark}</div>
	</div>
</div>
