...
<div class="wrap common_top common_success_box" id="body_box">
    ...
    <div class="clear15"></div>
    <dl>
        <dt class="success_icon3"><p><i></i>{$message}</p></dt>
        <dd><a href="{$jump_url}">[<u>Click here to return previous page</u>]</a></dd>
        <script>setTimeout("window.location.href='{$jump_url}'", 3000);</script> 
            </dl>
    <div class="clear15"></div>
    <div class="clear15"></div>
    <div class="clear15"></div>
